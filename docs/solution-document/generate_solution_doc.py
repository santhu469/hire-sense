...
def build():
    ...
    add_table(
        ...
        [
            ...
            ("Secrets Manager", "Anthropic API key, DB credentials, JWT signing key — never stored in code or images."),
    ...
    add_table(
        ...
        [
            ...
            ("AI / LLM", "Anthropic Claude API, structured/tool-use output for scoring and extraction"),
